      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-20 ">
          <div>
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 text-xs lg:text-base">
              {aboutTagsData.map((tag) => {
                const Icon = iconMap[tag.icon as keyof typeof iconMap];
                return (
                  <span
                    key={tag.id}
                    className="flex items-center gap-2 text-gray-700 border border-gray-200 rounded-lg px-3 py-1.5 lg:text-base"
                  >
