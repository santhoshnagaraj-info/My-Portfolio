...
export default function About() {
  return (
    <section id="about" className="px-[10%] py-[5%] grid grid-cols-1 items-center w-full h-screen-[50%] bg-transparent backdrop-blur-md border border-gray-400">
        ...
        <h2 className="font-bold text-gray-900 text-[300%]">Who am I?</h2>
            ...
            <div className="py-[3%] gap-[3%] flex flex-wrap">
              {aboutTagsData.map((tag) => {
                ...
                return (
                  <span
                    key={tag.id}
                    className="flex items-center gap-4 text-gray-700 border border-gray-200 rounded-lg px-3 py-1.5 lg:text-base"
                  >
            ...
            {aboutInfoData.map((info) => {
              ...
              return (
                <div key={info.id} className="flex items-start sm:items-center gap-3">
                  ...
                  <span className="text-gray-500 shrink-0">{info.label}</span>
